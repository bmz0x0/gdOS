...
/************************************************************************/
/*      H8/36079 Series Include File                         Ver 2.1    */
/************************************************************************/
...
struct st_abrk {                                        /* struct ABRK  */
               ...
               unsigned int     BAR;                    /* BAR          */
               unsigned int     BDR;                    /* BDR          */
               unsigned int     BARE;                   /* BARE         */
};                                                      /*              */
...
#define TZ0     (*(volatile struct st_tz0   *)0xFFF700) /* TZ0   Address*/
#define TZ1     (*(volatile struct st_tz1   *)0xFFF710) /* TZ1   Address*/
#define TZ      (*(volatile struct st_tz    *)0xFFF720) /* TZ    Address*/
#define RTC     (*(volatile struct st_rtc   *)0xFFF728) /* RTC   Address*/
#define LVD     (*(volatile struct st_lvd   *)0xFFF730) /* LVD   Address*/
#define OSCI    (*(volatile struct st_osci  *)0xFFF735) /* OSCI  Address*/
#define SCI3_2  (*(volatile struct st_sci3  *)0xFFF740) /* SCI3_2Address*/
#define IIC2    (*(volatile struct st_iic2  *)0xFFF748) /* IIC2  Address*/
#define TB1     (*(volatile struct st_tb1   *)0xFFF760) /* TB1   Address*/
#define FLASH   (*(volatile struct st_flash *)0xFFFF90) /* FLASH Address*/
#define TV      (*(volatile struct st_tv    *)0xFFFFA0) /* TV    Address*/
#define SCI3    (*(volatile struct st_sci3  *)0xFFFFA8) /* SCI3  Address*/
#define AD      (*(volatile struct st_ad    *)0xFFFFB0) /* A/D   Address*/
#define PWM     (*(volatile struct st_pwm   *)0xFFFFBC) /* PWM   Address*/
#define WDT     (*(volatile struct st_wdt   *)0xFFFFC0) /* WDT   Address*/
#define ABRK    (*(volatile struct st_abrk  *)0xFFFFC8) /* ABRK  Address*/
#define IO      (*(volatile struct st_io    *)0xFFFFD0) /* IO    Address*/
#define SYSCR1  (*(volatile union  un_syscr1*)0xFFFFF0) /* SYSCR1Address*/
#define SYSCR2  (*(volatile union  un_syscr2*)0xFFFFF1) /* SYSCR2Address*/
#define IEGR1   (*(volatile union  un_iegr1 *)0xFFFFF2) /* IEGR1 Address*/
#define IEGR2   (*(volatile union  un_iegr2 *)0xFFFFF3) /* IEGR2 Address*/
#define IENR1   (*(volatile union  un_ienr1 *)0xFFFFF4) /* IENR1 Address*/
#define IENR2   (*(volatile union  un_ienr2 *)0xFFFFF5) /* IENR2 Address*/
#define IRR1    (*(volatile union  un_irr1  *)0xFFFFF6) /* IRR1  Address*/
#define IRR2    (*(volatile union  un_irr2  *)0xFFFFF7) /* IRR2  Address*/
#define IWPR    (*(volatile union  un_iwpr  *)0xFFFFF8) /* IWPR  Address*/
#define MSTCR1  (*(volatile union  un_mstcr1*)0xFFFFF9) /* MSTCR1Address*/
#define MSTCR2  (*(volatile union  un_mstcr2*)0xFFFFFA) /* MSTCR2Address*/
#define CKCSR   (*(volatile union  un_ckcsr *)0xFFF734) /* CKCSR Address*/
